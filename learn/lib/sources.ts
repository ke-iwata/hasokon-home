...
export const sources: Source[] = [
  ...
  {
    id: 'fsa-kaisei-2026',
    title: '金融商品取引法及び資金決済に関する法律の一部を改正する法律案の概要',
    publisher: '金融庁',
    kind: 'gov',
  ...
  {
    id: 'fsa-dendai',
    title: '電子決済手段等取引業・電子決済等取扱業を行うみなさまへ',
    publisher: '金融庁',
    kind: 'gov',
    url: 'https://www.fsa.go.jp/common/shinsei/dendai/dentori.html',
    checkedAt: '2026-09-08',
  },
  {
    id: 'mof-taikou-2026',
    ...
    publisher: '財務省',
    kind: 'gov',
    url: 'https://www.mof.go.jp/tax_policy/tax_reform/outline/fy2026/08taikou_mokuji.htm',
    checkedAt: '2026-09-08',
  },
  {
    id: 'nta-crypto',
    title: '暗号資産等に関する税務上の取扱い及び計算書について',
    publisher: '国税庁',
    kind: 'gov',

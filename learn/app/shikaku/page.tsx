...
import { chapterBySlug, chapters, parts, robotsFor, SITE_URL } from '@/lib/curriculum';
...
export default function Page() {
  const chaptersFor = (tag: Tag) =>
    chapters.filter((c) => (c.shikaku ?? []).includes(tag));

...
- 2026-09-26：**本文の薄いツール4本に固有の中身を足した**（[thin-tool-content.md](./thin-tool-content.md)、
  傷病手当金・子育て支援金・半角全角・割り勘）。B（16本の noindex、#257）と同じ次の `v*` リリースで本番に出し、
  そのあと「クロール済み - インデックス未登録」の「修正を検証」をやり直す

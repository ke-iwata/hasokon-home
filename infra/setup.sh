#!/usr/bin/env bash
#
# hasokon home - ルートドメイン（hasokon.com）の配信基盤の構築
#
#   ./infra/setup.sh
#
...
DOMAIN="${DOMAIN:-hasokon.com}"
TEST_DOMAIN="${TEST_DOMAIN:-test.hasokon.com}"
PARENT_DOMAIN="${PARENT_DOMAIN:-hasokon.com}"
BUCKET="${BUCKET:-hasokon-com}"
TEST_BUCKET="${TEST_BUCKET:-${BUCKET}-test}"
REPO="${REPO:-ke-iwata/hasokon-home}"
...
CERT_STACK="hasokon-home-certificate"
SITE_STACK="hasokon-home-site"
...
# GitHub Pages時代の apex の A/AAAA レコードが残っていると、

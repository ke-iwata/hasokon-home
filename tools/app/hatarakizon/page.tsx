...
const faq = [
  ...
  {
    q: '保険料調整制度とは何ですか？',
    a: '2026年10月1日に始まった、短時間労働者の保険料負担を軽くする通算3年の時限措置です。対象になると、厚生年金保険料・健康保険料の本人負担が労使折半（保険料全体の50%）ではなく25〜48%になります（標準報酬月額88,000円以下で25%、126,000円で48%。3年目は軽減幅が半分になり、4年目から折半に戻ります）。減った分は事業主が一時的に立て替えますが、3か月後の保険料から還付されるため事業主の最終的な負担も増えません。軽減されるのは厚生年金保険料と健康保険料だけで、介護保険料・子ども・子育て支援金・雇用保険料と賞与にかかる保険料は対象外です。',
  },
  {
  ...
  },
  {
    ...
    a: '減りません。保険料の本人負担割合が変わるだけで、年金額の計算に使う標準報酬月額は変わらないためです（日本年金機構のパンフレットも「被保険者が将来受け取る年金額への影響はありません」と明記しています）。むしろ払う保険料が減るぶん、払った厚生年金保険料を年金の増分で取り戻すまでの年数は短くなります。この計算機の「手取り以外に増えるもの」は軽減の有無で変わらず、「取り戻すまで」の年数だけが短くなります。',
  },
  {

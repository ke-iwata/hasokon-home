...
export default function Page() {
  return (
    <>
      ...
      <h1>ルーレット</h1>
      <p className="lead">
        項目を入れて回すだけ。ランチ、当番、順番決めに。登録不要で、入れた内容はこの端末に保存されます。
      </p>
      ...
      <ol>
        <li>
          <strong>項目を入れる</strong> — 決めたい選択肢を入力します。名簿の貼り付け（改行・カンマ区切り）や、「1〜30」のような範囲指定もそのまま使えます。よく使う顔ぶれは「リストを保存」しておくと、次回から選ぶだけです。
        </li>
        <li>

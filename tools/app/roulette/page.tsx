...
const description =
  '項目を入れて回すだけの無料ルーレット。ランチ・当番・順番決めに。名簿の貼り付けや「1〜30」の範囲指定にも対応し、全員に一巡させる決め方も選べます。登録不要でブラウザだけで動きます。';
...
const faq = [
  ...
  {
    q: '同じ人ばかり当たるのを防げますか？',
    a: 'はい。「決め方」で「全員に一巡」を選ぶと、すべての項目が一度ずつ当たるまで同じものは出ません。「直近は避ける」を選べば、最近当たった項目が選ばれにくくなります。過去の結果はこの端末に記録され、項目ごとの当選回数も確認できます。',
  },
  {
    q: '名簿をまとめて入力できますか？',
  ...
  return (
    <>
      ...
      <ol>
        ...
        <li>
          <strong>決め方を選ぶ</strong> — 「全員に一巡」にすると、全員が一度ずつ当たるまで同じ人は出ません。
          「直近は避ける」なら、最近当たった項目が選ばれにくくなります。当番決めのように繰り返し使う場面で偏りません。
        </li>
        <li>

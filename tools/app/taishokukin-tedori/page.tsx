...
const faq = [
  {
    ...
    a: 'iDeCo（確定拠出年金）の一時金を先に受け取り、その後に会社の退職金を受け取る場合、退職所得控除の計算で「重なっている期間」が差し引かれる仕組みのことです。令和7年度税制改正により、この重複排除の対象になる期間が「前の一時金を受けた年が前年以前4年内」から「前年以前9年内」に延びました（所得税法施行令 第70条）。2026年1月1日以後に支払を受ける退職金から適用されます。iDeCoを先に受け取ってから会社を辞めるまで5年空ければ控除が満額使えた、という従来の説明は2026年以後は成り立ちません。',
  },
  {
    q: '10年ルールは誰に関係しますか？',
    a: '「iDeCo等の一時金を先に受け取り、あとから会社の退職金を受け取る」順番の方だけです。iDeCoをまだ受け取っていない方、年金形式で受け取っている方には関係ありません。また、退職金を先に受け取ってiDeCoの一時金を後で受け取る逆の順番は、従来どおり19年内で判定します（本ツールは「iDeCo一時金が先」のケースだけを計算します）。',
  },
  {
    q: '重複期間の「短縮」とは何ですか？',
    a: '前に受け取った一時金の額が、その当時の退職所得控除額に満たなかった場合、重複期間はその金額に応じた年数（みなし勤続年数）まで短縮されるという決まりです（所得税法施行令 第70条）。たとえば掛金期間15年・一時金200万円なら、当時の控除額は600万円なので一時金はこれに満たず、みなし勤続年数は200万円 ÷ 40万円 ＝ 5年になります。期間が15年重なっていても、差し引かれるのは40万円 × 5年 ＝ 200万円だけです。iDeCoの一時金は掛金期間で計算した控除額より小さいことが多いため、この短縮を入れないと控除を引きすぎ、税金を実際より多く見積もることになります。',
  },
  {
    ...
    <>
      ...
      */}
      ...
      <p>
        ...
        <strong>2026年1月1日以後に支払を受ける退職金からは「前年以前9年内」</strong>
        になります（所得税法施行令 第70条）。
        「iDeCoを先に受け取って5年空ければ控除が満額使える」という説明は、
        2026年以後の退職金には当てはまりません。
      </p>
      <p>
      ...
      <p>
        ...
        重複期間はその金額に応じた年数（<strong>みなし勤続年数</strong>）まで短縮されます
        （所得税法施行令 第70条）。
      </p>
      <ul>
        <li>一時金が800万円以下：みなし勤続年数 ＝ 一時金 ÷ 40万円（1年未満切捨て）</li>
        <li>一時金が800万円超：みなし勤続年数 ＝（一時金 − 800万円）÷ 70万円 ＋ 20年</li>
      </ul>
      <p>
        たとえば<strong>掛金期間15年・一時金200万円</strong>の場合、当時の退職所得控除額は
        40万円 × 15年 ＝ 600万円。一時金はこれに満たないので、みなし勤続年数は
        200万円 ÷ 40万円 ＝ <strong>5年</strong>です。期間が15年重なっていても、
        差し引かれるのは40万円 × 5年 ＝ 200万円だけになります。
      </p>
      <p>
      ...
      <ToolMeta slug="taishokukin-tedori" ymyl>
        ...
        ／所得税法 第30条・第89条・第201条、同施行令 第69条〜第70条、地方税法 第50条の2〜第50条の6
        にもとづき作成（2026年9月16日確認）。
      </ToolMeta>
    </>
  );
}

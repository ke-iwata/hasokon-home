...
const faq = [
  ...
  },
  {
    ...
    a: '消えます。このツールはCanvasで画像を描き直して保存するため、元のファイルに付いていたEXIF（GPSの位置情報・撮影日時・カメラの機種・レンズ情報）は出力に引き継がれません。SNSやフリマアプリに写真を上げる前に自宅の位置情報を落としたい、という用途にそのまま使えます。ただし撮影時の「向き」の情報だけは読み取って、縦で撮った写真が横倒しにならないように、画像そのものを正しい向きに直してから書き出しています。',
  },
  {
  ...
  return (
    <>
      ...
      <p className="hint">
        ...
        という仕組みです。向きだけは消えると縦の写真が横倒しになるため、書き出す前に画像そのものを正しい向きに直しています。
      </p>

...
export default function PrivacyPage() {
  return (
    <>
      ...
      <h2>入力データの取り扱い</h2>
      <p>
        本サイトの各ツールに入力された数値・文字列などのデータは、すべてお使いのブラウザ内でのみ処理されます。
        入力内容がサーバーに送信・保存されることは一切ありません。
      </p>
      ...
      <h2>アクセス解析について</h2>
      <p>
        本サイトは、サービス向上のためアクセス解析ツールを利用する場合があります。
        解析データは匿名で収集されており、個人を特定するものではありません。
      </p>

      <h2>免責事項</h2>
      <p>
        本サイトの計算結果および掲載情報は目安であり、その正確性・完全性・最新性を保証するものではありません。
        本サイトの利用によって生じたいかなる損害についても、運営者は一切の責任を負いかねます。
        制度に関する正確な情報は、必ず公的機関等の一次情報をご確認ください。
      </p>

      <h2>著作権について</h2>
      <p>
        本サイトに掲載されている文章・画像・プログラム等のコンテンツの著作権は、運営者に帰属します。
        法律で認められた引用の範囲を超えて、無断で複製・転載・改変・再配布することを禁じます。
        引用の際は、出典として本サイト名とURLの明記をお願いします。
      </p>
      <p>

...
export default function Page() {
  return (
    <>
      ...
      <h1>傷病手当金 計算機</h1>
      <p className="lead">
        病気やケガで会社を休んだときにもらえる傷病手当金の目安を計算します。
        月収と休んだ日数を入れるだけで、日額・支給日数・支給総額がわかります。
      </p>
      ...
      <p>
        ...
        <strong>業務外</strong>の病気やケガで働けなくなったときに、
        生活を保障するために支給される給付です。次の条件をすべて満たすと支給されます。
      </p>
      <ul>
      ...
      <p>
        支給期間は支給開始日から<strong>通算1年6ヶ月</strong>です。2022年1月の制度改正で、それまでの「支給開始から暦の上で1年6ヶ月」から「支給された期間を通算して1年6ヶ月」に変わりました。
        これにより、がん治療などで入退院を繰り返す場合でも、復職して給与が出ていた期間は支給期間にカウントされず、実際に休んだ期間の合計で1年6ヶ月分まで受け取れます。
      </p>

      <div className="note">
        本ツールの計算は目安です。実際の支給額は支給開始日以前12ヶ月の各月の標準報酬月額の平均から算定されるため、昇給・降給があった場合は結果と異なることがあります。
        また、健康保険組合によっては法定の傷病手当金に上乗せされる「付加給付」がある場合があります。正確な金額は加入している健康保険にご確認ください。
        なお、国民健康保険（自営業・フリーランス等）には原則として傷病手当金の制度はありません。
      </div>

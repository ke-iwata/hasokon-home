...
export default function Page() {
  return (
    <>
      ...
      <p>
        ただし<strong>被保険者期間が12ヶ月に満たない場合は上限があります</strong>。
        その期間の標準報酬月額の平均と、全被保険者の標準報酬月額の平均額（協会けんぽでは32万円）のうち低いほうで計算されるため、給与が高い方でも日額は約7,113円で頭打ちになります。
        転職・入社から1年以内の方は計算機のチェックボックスをオンにしてください。
      </p>

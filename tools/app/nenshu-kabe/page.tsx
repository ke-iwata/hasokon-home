...
const faq = [
  ...
  {
    q: '「週20時間の壁」とは何ですか？',
    a: '賃金要件の撤廃後、勤務先の社会保険に加入するかどうかを分けるのが週の所定労働時間20時間になったことを指す言い方です。従業員51人以上の勤務先で週20時間以上働くと、年収がいくらであっても厚生年金・健康保険に加入し、保険料が天引きされます。手取りを抑えたい場合に調整すべきは年収ではなく週の所定労働時間です。なお企業規模の要件も2027年10月から段階的に縮小され、2035年10月に撤廃される予定です。',
  },
  {

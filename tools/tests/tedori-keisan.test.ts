...
describe('calcTedori — 社会保険料が料額表どおり', () => {
   ...
   * - 雇用保険 5,000,000 × 0.5%（令和8年度。標準報酬月額ではなく実際の賃金にかかる）
   */
  it('年収500万円の内訳が保険料額表と一致する', () => {
    ...
    expect(p.employment).toBe(25_000);
  });
...
describe('takeHomeTable — 手取り早見表', () => {
  ...
  it('40歳未満の早見表（料率改定に気づくためのスナップショット）', () => {
    expect(
      ...
      [1_000_000, 844_892, 70_407, 0],
      [1_500_000, 1_264_368, 105_364, 9_000],
      [2_000_000, 1_644_520, 137_043, 9_573],
      [2_500_000, 2_041_151, 170_095, 8_168],
      [3_000_000, 2_399_295, 199_941, 8_168],
      [3_500_000, 2_786_421, 232_201, 8_168],
      [4_000_000, 3_167_353, 263_946, 8_168],
      [4_500_000, 3_546_925, 295_577, 8_168],
      [5_000_000, 3_940_994, 328_416, 28_843],
      [5_500_000, 4_284_439, 357_036, 36_756],
      [6_000_000, 4_660_630, 388_385, 36_756],
      [6_500_000, 5_037_036, 419_753, 36_756],
      [6_600_000, 5_079_697, 423_308, 36_756],
      [6_700_000, 5_123_231, 426_935, 5_207],
      [7_000_000, 5_307_512, 442_292, 8_168],
      [7_500_000, 5_633_369, 469_447, 8_168],
      [8_000_000, 5_946_474, 495_539, 8_168],
      [8_500_000, 6_294_940, 524_578, 8_168],
      [8_600_000, 6_354_114, 529_509, 8_168],
      [9_000_000, 6_614_031, 551_169, 8_168],
      [9_500_000, 6_943_332, 578_611, 8_168],
      [10_000_000, 7_272_634, 606_052, 8_168],
    ]);
  });

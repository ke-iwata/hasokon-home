 ...
 *
 * 【データ更新箇所】
 * 1. AdSenseの審査に通ったら ADSENSE_CLIENT に「ca-pub-」から始まるIDを入れる
 * 2. AdSense管理画面で広告ユニットを2つ作り、スロットIDを AD_SLOTS に入れる
 *
 * ADSENSE_CLIENT が空の間は広告スクリプト・広告枠・ads.txt のいずれも出力されない。
 * 未設定のまま公開しても壊れないので、審査前でも安全にデプロイできる。
 */

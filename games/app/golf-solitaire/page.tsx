...
export default function Page() {
  return (
    <>
      ...
      <h2>ゴルフソリティアの由来</h2>
      <p>
        ゴルフ（Golf Solitaire）は古くから遊ばれてきた伝統的なトランプの一人遊びで、ルールにも名称にも権利者はいません。名前の由来は、スポーツのゴルフが打数の少なさを競うのと同じように、
      ...
      <p>
        ...
        は、このゴルフから<strong>取り方</strong>
        を受け継ぎ、並べ方を3つの山にしたものだと言われています。このサイトには他にも、定番の

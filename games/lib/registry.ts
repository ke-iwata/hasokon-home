...
export const games: GameDef[] = [
  ...
  },
  {
    ...
    // **`public` に上げる前に J-PlatPat で名称の商標を確認すること**
    // （登録があれば「色水の並べ替えパズル」等に切り替える。スネーク・ナンプレと同じ手順）
    slug: 'color-sort',
    icon: 'Tubes',
    name: '色水ソート',
    description:
      '色水を試験管に注ぎ分けて同じ色を1本にそろえるパズル。かんたん・ふつう・むずかしいの3段階。時間制限なしでのんびり遊べます。',
    // 実機での手触り（試験管の押しやすさ・1画面に収まるか）と名称の商標確認が済むまで公開しない。
    // 公開の条件は仕様書（docs/features/game-color-sort.md）の状態行に書いてある
    stage: 'preview',

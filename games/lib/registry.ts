...
export const games: GameDef[] = [
  ...
  {
    // 「落として同じもの同士を合体させる」メカニクスはアイデアであって
    // 著作権の保護対象ではなく、同系のゲームが各ストアに多数ある。
    // ただし**「スイカゲーム」は Aladdin X 社の商品名（商標）**なので、
    // 名前・slug・見出し・説明のどこにも使わない。顔つきの果物の意匠も真似ず、
    // 最大の果物もスイカにしていない（docs/features/game-fruit-merge.md の
    // 「名称・権利の注意」。ヤッツィー/ヨットと同じ整理）。
    // **公開の条件は仕様書の判定リスト**（1画面・60個で震えなし・1プレイ3〜10分・
    // 60fps）。満たしたら `preview` → `public` に上げる。
    // マージ系をまとめて見せたいので、一覧では 2048 の隣に置きたいが、
    // 公開までは末尾に置いておく
    slug: 'fruit-merge',
    icon: 'FruitMerge',
    name: 'フルーツ合体パズル',
    description:
      '箱に果物を落として、同じ果物どうしをぶつけて大きく育てる物理パズル。11段階の果物を合体させて高得点を狙います。',
    stage: 'wip',
